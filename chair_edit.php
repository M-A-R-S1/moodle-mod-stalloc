...
if (has_capability('mod/stalloc:examination_member', context_module::instance($instance->id)))  {
    ...
    if ($form_chair_edit->is_cancelled()) {
        redirect(new moodle_url('/mod/stalloc/chair.php', ['id' => $id]), "Chair Edition Canceled!", 4, 'NOTIFY_INFO');
        ...
        redirect($redirecturl, "Chair Successfully Edited", 2, \core\output\notification::NOTIFY_SUCCESS);
    }


    echo '<h2 class="mt-3 mb-3 ml-3">EDIT CHAIR</h2>';
